...
BAR=$me'xxxxxxxxxxx'
for i in {1..100}; do
echo -ne "\r[+]$Loading Data Pleas Wait [+]$jo  [>$i<]"
sleep .1
done
echo
echo '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'
figlet 'CYBER IND TEAM' |lolcat  -a -d 10
echo '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'
echo
BAR=$me'╔─━━━━━━━━━━━━━━━━━━━━━━━━─╗'
for i in {1..47}; do
...
echo
BAR=$me'║'$cy'AUTHOR   '$':'$jo'E Z 01'
for i in {1..47}; do
echo -ne "\r${BAR:0:$i}"
sleep .1
done
echo
BAR=$me'║'$cy'WhatsApp :08228890xxxx'
for i in {1..47}; do
 echo -ne "\r${BAR:0:$i}"
sleep .1
done
echo
BAR=$me'║'$cy'Phatner  '$':'$jo'Riza'
for i in {1..47}; do
 echo -ne "\r${BAR:0:$i}"
sleep .1
done
echo
BAR=$me'║'$cy'YOUTUBE  '$':'$jo'E Z 01'
for i in {1..47}; do
 echo -ne "\r${BAR:0:$i}"
sleep .1
done
...
echo
echo $pur"╔─━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━─╗"
echo ๏SILAHKAN PILIH MENU HACK YANG TERSEDIA๏ | lolcat -a -d 10
echo $pur"╚─━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━─╝"
echo
echo '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'
...
echo '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'
echo
echo $me"┌==="$bi"["$i"EZ01"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
then
clear
figlet -f slant "JUST JUST W A I T"|lolcat
sleep 1
...
then
clear
figlet -f slant "JUST W A I T"|lolcat
sleep 1
